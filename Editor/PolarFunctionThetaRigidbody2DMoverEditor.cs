...
{
    [CustomEditor(typeof(PolarFunctionThetaRigidbody2DMover))]
    public class PolarFunctionThetaRigidbody2DMoverEditor
        : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (
                ...
                (int)PolarFunctionThetaRigidbody2DMover.MovementMode.Discrete
            )
            {
                EditorGUILayout.Space();
